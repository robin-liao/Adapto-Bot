// const { RTCAudioSource } = import("wrtc").nonstandard;

// const twoPi = 2 * Math.PI;

// export class RTCAudioSourceSineWave {
//   constructor(options = {}) {
//     options = {
//       frequency: 440,
//       channelCount: 1,
...
//     const { channelCount, sampleRate } = options;
...
//           samples[i * channelCount + j] =
//             a[j] * Math.sin(twoPi * frequency * time) * maxValue;
//         }
//       }
//       source.onData(data);
